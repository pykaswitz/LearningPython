...
def main():
    ...
    try:
        ...
        while not valid_player_name:
            ...
            if player_1 == "" or player_1 is None:
                print(Fore.RED + "You must enter a name." + Fore.WHITE)
                continue
            else:
        ...
        while not valid_player_name:
            ...
            if player_2 == "" or player_2 is None:
                print(Fore.RED + "You must enter a name." + Fore.WHITE)
                continue
            else:
                valid_player_name = True
        ...
        print()
        print(Fore.RED + f"ERROR: Leaderboard is corrupt or empty: {je}" + Fore.WHITE)
        print(Fore.RED + f"ERROR: Delete file leaderboard.json to reset." + Fore.WHITE)
        print()
